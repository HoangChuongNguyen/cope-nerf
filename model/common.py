...
# def transform_world_to_pixels(pts, camera_mat, world_mat=None, scale_mat=None):

# def origin_to_camera(n_points, camera_mat, scale_mat, invert=True):
...
#     p_world = scale_mat @ camera_mat @ p

#     # Transform points back to 3D coordinates
#     p_world = p_world[:, :3].permute(0, 2, 1)
#     return p_world
# def image_points_to_camera(image_points, camera_mat, scale_mat,
#                           invert=True):
#     batch_size, n_pts, dim = image_points.shape
#     assert(dim == 2)
#     device = image_points.device
#     d_image = torch.ones(batch_size, n_pts, 1).to(device)
#     return transform_to_camera(image_points, d_image, camera_mat,
#                               scale_mat, invert=invert)
# def transform_to_camera(pixels, depth, camera_mat, scale_mat=None,
...
#     p_world = scale_mat @ camera_mat @ pixels_depth
