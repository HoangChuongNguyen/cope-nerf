...
class CheckpointIO(object):
    ...
    def save(self, filename, lastest_checkpoint, **kwargs):
        ...
        if lastest_checkpoint:
            save_dir = f'{self.checkpoint_dir}/models/weights'
        else:
            save_dir = f'{self.checkpoint_dir}/models/weights_{kwargs["epoch_it"]}'
    ...
    def load(self, filename, device=None, load_epoch=None, load_model_only=False):
        ...
        if load_epoch is not None:
            print(f"=> Loading model at epoch {load_epoch}")
            filename = filename.replace('/weights/', f'/weights_{load_epoch}/')
        else:
            print(f"=> Loading the lastest checkpoint")
        if is_url(filename):
